...
function build() {
  ...
  placeObject(tiles, objects, { type: ObjectType.BICYCLE_RACK, x: 20, y: 13 });
  placeObject(tiles, objects, { type: ObjectType.BICYCLE_RACK, x: 25, y: 13 });
  placeObject(tiles, objects, { type: ObjectType.CLOCK_TOWER, x: 32, y: 10 });
